...
import { createStackNavigator, NavigationActions, StackActions,createAppContainer } from 'react-navigation';
...
export default LoginStack = createAppContainer(createStackNavigator({
